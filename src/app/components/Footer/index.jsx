    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <div class="flex mt-8 space-x-6 text-gray-600">
          <a class="hover:opacity-75" href='https://www.facebook.com/construtorabcr' target="_blank" rel="noreferrer">
          ...
          <a class="hover:opacity-75" href='https://api.whatsapp.com/send?phone=11966960799' target="_blank" rel="noreferrer">
        ...
        >
          ...
          <a class="hover:opacity-75" href='https://www.tiktok.com/@bcrconstrutora' target="_blank" rel="noreferrer">
      ...
      <div class="grid grid-cols-1 gap-8 lg:col-span-2 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <nav class="flex flex-col mt-6 space-y-6 text-md text-gray-500">
            ...
            <a class="hover:opacity-75" href={`https://api.whatsapp.com/send?phone=11966960799`} target="_blank" rel="noreferrer" >Whatsapp</a>
